	...
	a.MixItUp = function() {
		...
		_processClick : function(c, d) {
			var e = this,
				f = function(c, d, f) {
					...
					g._handled["_" + d][e.selectors[d]] = g._handled["_" + d][e.selectors[d]] === b ? 1 : g._handled["_" + d][e.selectors[d]] + 1, g._handled["_" + d][e.selectors[d]] === g._bound["_" + d][e.selectors[d]] && (c[(f ? "remove" : "add") + "Class"](e.controls.activeClass),
		...
		multiMix : function() {
			...
			if (a._execAction("multiMix", 0, arguments), a._mixing)
				...
				a.controls.enable && !a._clicking && (a.controls.toggleFilterButtons && a._buildToggleArray(), a._updateControls(c.command, a.controls.toggleFilterButtons)), a._queue.length < 2 && (a._clicking = !1),
